...
base_url="https://mgmt.auth-staging.adobe.com"
...
RESPONSE1=$(curl -s 'https://sp.auth-staging.adobe.com/o/client/register' \
  -X 'POST' \
...
RESPONSE2=$(curl -s "https://sp.auth-staging.adobe.com/o/client/token?grant_type=client_credentials&client_id=$RESPONSE1_CLIENT_ID&client_secret=$RESPONSE1_CLIENT_SECRET" \
    -X 'POST' \
    -H 'Content-Type: application/json' )
